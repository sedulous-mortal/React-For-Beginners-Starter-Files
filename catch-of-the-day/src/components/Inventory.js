...
renderLogin(){
    return(
        <nav className="login">
          ...
          this.authenticate('gitub')}>Log In with Github</button>
    ...
    renderInventory(key){
        ...
        <div className="fish-edit" key={key}>
            ...
            placeholder="Fish Desc" onChange={(e) => this.handleChange(e, key)}>
            </textarea>
    ...
    render(){
        ...
        //Check i fthey are the owner of the current store
...
Inventory.propTypes={
    fishes: React.PropTypes.object.isReuired,
